                                ...
                                <div class="" style="overflow:hidden;">
                                    <div class="col-md-12">
                                        ...
                                        <form name="ad-form" id="ad-form" method="post"
                                            action="<?php echo base_url('/admin/updatelocality');?>" role="form"
                                            enctype="multipart/form-data" onsubmit="return checkTitle();">
                                            <div class="messages"></div>
                                            <input type="hidden" name="localityid" id="localityid" value="<?php echo $editData[0]['id'];?>" readonly />
                                            <div class="controls">
                                                                        ...
                                                                        <tr id="row0">
                                                                            <td>
                                                                                <select name="details[0][countries]" class="myCountries">
                                                                                    <?php foreach ($countries as $kc1 => $vc1) {?>
                                                                                        <option value="<?php echo $vc1['id'];?>" <?php if($vc1['id']==$selected['countriesid']){echo 'selected';}?>><?php echo $vc1['name'];?></option> 
                                                                                        <?php
                                                                                    } ?>
                                                                                </select> 
                                                                            </td>  
                                                                            <td>
                                                                                <select id="myStates0" name="details[0][states]" class="myStates"> 
                                                                                    ...
                                                                                    <?php foreach ($states as $kc2 => $vc2) {?>
                                                                                        <option value="<?php echo $vc2['id'];?>" <?php if($vc2['id']==$selected['stateid']){echo 'selected';}?>><?php echo $vc2['name'];?></option> 
                                                                                        <?php
                                                                                    } ?>
                                                                                </select> 
                                                                            </td>    
                                                                            <td>
                                                                                <select id="myCities0" name="details[0][cities]" class="myCities"> 
                                                                                    ...
                                                                                    <?php foreach ($cities as $kc3 => $vc3) {?>
                                                                                        <option value="<?php echo $vc3['id'];?>" <?php if($vc3['id']==$selected['cityid']){echo 'selected';}?>><?php echo $vc3['name'];?></option> 
                                                                                        <?php
                                                                                    } ?>
                                                                                </select> 
                                                                            </td>    
                                                                            <td>
                                                                                <input type="text" name="region" value="<?php echo $editData[0]['name'];?>">
                                                                            </td>    
                                                                            </tr>  
                                                                </table>  
                                                            </div>  
