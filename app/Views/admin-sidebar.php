        ...
        <div class="sidebar-box listing-box cat1 mb-40">
            ...
            <div class="sidebar-contant">
                ...
                <div class="panel-group" id="adminaccordion">
                    ...
                    <a class="cat_list" href="<?php echo base_url($type.'/report/'.$user_id);?>">
                    <div class="panel panel-default">
                        <div class="panel-heading <?php if($currentpage=='report'){ echo 'selected'; }?>">
                            <h4 class="panel-title">
                                <span style="padding-left:10px;">Reported Ads</span>
                                <i class="fa fa-caret-right"></i>
                            </h4>
                        </div>
                    </div>
