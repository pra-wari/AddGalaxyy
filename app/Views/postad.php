                                        ...
                                        success: function (data) {
                                            ...
                                            $.each(result.attributes, function (index, v2) {
                                                ...
                                                if(v2.attribute_name=='Brand'){
                                                    ...
                                                    v2.attribute_name + '</div><div class="listing" style="border: 2px solid #ccc;height:100%;">' + rhtml +
                                                    '</div></div>';
                                                }
                            ...
                            <div class="col-md-12">
                                <div class="form-group plan_group" >
                                    ...
                                    <div class="pricing-wrapper clearfix packagemob">
                                       ...
                                       <input type="hidden" id="plantype1" name="plantype1" value="1">
                                        <input type="hidden" id="plantype2" name="plantype2" value="2">
                                        <input type="hidden" id="plantype3" name="plantype3" value="3">
                                        <input type="hidden" id="plantype4" name="plantype4" value="4">
                                        <!-- ======= Pricing Table ============-->
                                        <?php
                                        $ci = 1;
                                        ...
                                        <?php if($value['plan_name']=='FREE AD PLAN'){
                                            ?>
                                            <option value="0-18" selected>30 days</option>
                                            <?php
                                        }
                                        ?>
...
<script>
    ...
    function getPrice(selected, id, type) {
        ...
        if(type=="free")
            ...
            $("#plantype2").val("premium");
        else if(type=="sgallery")
            $("#plantype3").val("sgallery");
        else if(type=="featured")
            $("#plantype4").val("featured");
    }
</script>