                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form name="ad-form" id="ad-form" method="post"
                                            ...
                                            foreach ($settings as $key => $value) {
                                                if($value['icon_path']=='userverification'){
                                                    ?>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="userverification">
                                                                    <option value="0" <?php if($value['option_value']==0){echo 'selected';} ?>>OFF</option>
                                                                    <option value="1" <?php if($value['option_value']==1){echo 'selected';} ?>>ON</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
